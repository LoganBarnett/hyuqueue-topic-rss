# NixOS (Linux/systemd) module for the hyuqueue-topic-rss-server service.
...
#
#   inputs.hyuqueue-topic-rss.nixosModules.server
#
...
#
#   locations."/".proxyPass =
#     "http://unix:${config.services.hyuqueue-topic-rss-server.socket}";
#
